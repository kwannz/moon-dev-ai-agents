"""
GapAdvantage strategy implementation using TA-Lib indicators.
Uses gap-and-go setup for trading decisions.
"""
...
bt = Backtest(data, GapAdvantage, cash=1_000_000, commission=.002)
stats = bt.run()
print(stats)
